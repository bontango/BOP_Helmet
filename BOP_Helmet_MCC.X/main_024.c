...
ei();
 ...
 while(1)  { 
     ...
     switch(fading_level) {
         case 3: TMR4_Period8BitSet(0x3); //minimum/no fade OFF OFF
                 break;
         case 2: TMR4_Period8BitSet(30); // ON OFF
                 break;
         case 1: TMR4_Period8BitSet(60); //99 for 12,8mS -> 400mS fading OFF ON
                 break;
         case 0: TMR4_Period8BitSet(99); //ON ON
                 break;                  
     }
